...
> Status: ✅ COMPLETA — documento original sem modificações a partir da seção "Documentação Oficial Completa (verbatim)" abaixo
> Ver também: `api_capabilities.md` — resumo das capacidades relevantes para nosso ETL

---

## Quick Reference pro ETL

> Fundido de `mediasmart_api_reference.md` em 2026-08-09 (arquivo standalone removido —
> conteúdo consolidado aqui para não duplicar fonte). Resumo estruturado para uso direto
> no desenvolvimento do ETL; incompleto em seções de Publisher Lists, Geolists, Deals —
> para essas, ou qualquer dúvida não coberta aqui, use a documentação oficial completa
> abaixo desta seção.
...
Conforme documentação oficial (seção verbatim abaixo): *"A strategy is a campaign, but linked to another campaign that is considered as a parent."*
...
> Esta seção documenta achados que **não constam explicitamente na doc oficial** — descobertos via análise do Campaign Body (seção verbatim abaixo, linha ~2179+) e testes em produção.
...
## Documentação Oficial Completa (verbatim)
