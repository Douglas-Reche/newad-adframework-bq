...
| `../hub/README.md` | ✅ ATUAL | 2026-08-11 | Documentação do painel Streamlit (Tier 3) — abas, exceção ao invariante read-only, deploy/redeploy, tema visual. Atualizado 2026-08-11: checklist de UX/UI parcial (Bento Grid, filtro de Jobs, botões primários, comparação de custo no Farol) — commits `c0ceb02`/`e904535`, **no repositório, deploy ainda pendente** (ver `known_issues.md` "Aberto — Hub / Deploy") |
