...
> Movido para `docs/_legacy/` em 2026-08-05 (referência histórica confirmada por Douglas — bug do Admin UI mencionado neste doc não será mais tocado, pode ser desconsiderado).
---
